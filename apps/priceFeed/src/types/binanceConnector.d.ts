...
//   export declare type BinanceProductListOptionSortBy = 'START_TIME' | 'LOT_SIZE' | 'INTEREST_RATE' | 'DURATION'

//   export declare type BinanceProductListOptionStatus = 'ALL' | 'SUBSCRIBABLE' | 'UNSUBSCRIBABLE'

//   export declare type BinanceProductStatus = 'PURCHASING' | 'PRE_REDEMPTION' | 'RUNNING' | 'REDEEMED'
...
//   export declare type BinanceRateLimitType = 'ORDERS' | 'RAW_REQUESTS' | 'REQUEST_WEIGHT'
...
//   export declare type BinanceFill = Pick<BinanceAccountTrade, 'price' | 'qty' | 'commission' | 'commissionAsset'>
...
//   export declare type BinanceCanceledOcoOrder = Pick<BinanceOrder, 'symbol' | 'orderListId'> & {
...
//   export declare type BinanceNewOrder = BinanceOrderRespACK | BinanceOrderRespFULL | BinanceOrderRespRESULT
...
//     allOrders(symbol: BinanceSymbol, options?: BinanceAllOrdersOptions): Promise<BinanceApiResponse<BinanceOrder[]>>

//     apiPermissions(): Promise<BinanceApiResponse<BinanceApiKeyPermission>>

//     avgPrice(symbol: BinanceSymbol): Promise<BinanceApiResponse<BinanceAvgPrice>>

//     cancelOpenOrders(
//       symbol: BinanceSymbol
//     ): Promise<BinanceApiResponse<(BinanceCanceledOrder | BinanceCanceledOcoOrder)[]>>

//     exchangeInfo(): Promise<BinanceApiResponse<BinanceExchangeInfo>>

//     getOrder(symbol: BinanceSymbol, options?: BinanceGetOrderOptions): Promise<BinanceApiResponse<BinanceOrder>>
...
//     openOrders(options?: BinanceOpenOrdersOptions): Promise<BinanceApiResponse<BinanceOrder[]>>
...
//     ticker24hr(symbol: BinanceSymbol): Promise<BinanceApiResponse<BinanceTicker24hr>>

//     tickerPrice(symbol: BinanceSymbol): Promise<BinanceApiResponse<BinanceTickerPrice>>
//   }
// }
